package profittracker.controllers;
...
import profittracker.exception.ErrorDetails;
import profittracker.exception.TradeNotFoundException;
import profittracker.services.AggregatedTradeService;
import profittracker.services.BinanceApiTradeService;
import profittracker.services.ExcelTradeService;
import profittracker.services.TradeService;
...
public class TradeController {
	...
	public String saveAllAggTrades() {
		tradeService.saveAllAggregated();
		return "redirect:/trade/list";
	}
	...
	public String handleTradeNotFoundException(TradeNotFoundException ex, WebRequest request, Model model) {
		...
		return "trade/errorpage";
	}

	@RequestMapping("/trade/errorpage")
